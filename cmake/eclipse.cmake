...
execute_process(COMMAND /usr/bin/which eclipse-clp OUTPUT_VARIABLE ECLIPSE_BIN RESULT_VARIABLE WHICH_RESULT ERROR_QUIET)
if (NOT ECLIPSE_BIN)
  execute_process(COMMAND /usr/bin/which eclipse OUTPUT_VARIABLE ECLIPSE_BIN RESULT_VARIABLE WHICH_RESULT ERROR_QUIET)
endif()
...
if (ECLIPSE_BIN)
	...
	if ((${WHICH_RESULT} EQUAL 0) AND (IS_ABSOLUTE ${ECLIPSE_BIN}))
		...
		if (IS_DIRECTORY ${ECLIPSE_DIR})
			...
			#foreach(DIR ${ECLIPSE_INCDIR} /usr/local/include/eclipse-clp /usr/include/eclipse-clp)
			#	if (EXISTS ${DIR}/eclipse.h)
			#		set(ECLIPSE_INCLUDE_DIRS ${ECLIPSE_INCLUDE_DIRS} ${DIR})
			#	endif()
			#endforeach()

			find_library(ECLIPSE_LIB_ABS NAMES eclipse PATHS "${ECLIPSE_DIR}/lib/${ECLIPSE_HOSTARCH}" REQUIRED)

			add_library(eclipse UNKNOWN IMPORTED GLOBAL)
			set_target_properties(eclipse PROPERTIES IMPORTED_LOCATION ${ECLIPSE_LIB_ABS})
			set_target_properties(eclipse PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${ECLIPSE_DIR}/include/${ECLIPSE_HOSTARCH}")
		endif()
	endif()
endif()
